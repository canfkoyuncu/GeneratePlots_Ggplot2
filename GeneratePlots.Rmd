---
title: "Generate plots using ggplot library." 
Please visit the following link for more information.
http://www.sthda.com/english/wiki/ggplot2-box-plot-quick-start-guide-r-software-and-data-visualization
---

readxl -> reading an xlsx file
ggplot2 -> ploting the data
cowplot -> plotting multiple plots on a grid
```{r}
library(readxl)
library(ggplot2)
library(cowplot)
...
Generate four different box plots. You should be easily change your plot type by changing the geom_boxplot command such as geom_violin.  
```{r}
